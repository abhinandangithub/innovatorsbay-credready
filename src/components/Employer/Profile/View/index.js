			...
			<div className="profile-view">
				<div className="content">
					<ul className="listing">
						...
						<li>
							<p>Hiring Needs</p>
							<p>{props.profile.org.hires_required && props.hiringKeys.length > 0 && props.hiringKeys.find(val => val.id === props.profile.org.hires_required).range_display_value}</p>
						</li>
						<li>
							<p>Company Size</p>
							<p>{props.profile.org.company_size && props.companySizeKeys.length > 0 && props.companySizeKeys.find(val => val.id === props.profile.org.company_size).range_display_value}</p>
						</li>
						<li>
